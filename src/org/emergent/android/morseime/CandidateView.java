...
public class CandidateView extends View {
  ...
  private int mScrollX; // todo figure out what this should be
  ...
  public CandidateView(Context context, AttributeSet attrs) {
    super(context, attrs);
        mSelectionHighlight = context.getResources().getDrawable(R.drawable.list_selector_background_pressed); // todo
