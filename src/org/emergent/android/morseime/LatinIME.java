...
public class LatinIME extends InputMethodService
  ...
  public View onCreateInputView() {
    mInputView = (MorseKeyboardView) getLayoutInflater().inflate(
        R.layout.input, null);
  ...
  public void onStartInputView(EditorInfo attribute, boolean restarting) {
    ...
    if (TRACE) Debug.startMethodTracing("/data/trace/morseime");
  }
  ...
  public void onDisplayCompletions(CompletionInfo[] completions) {
    if (false) {
      LOG.info("Received completions:");
      for (int i = 0; i < (completions != null ? completions.length : 0); i++) {
        LOG.info("  #" + i + ": " + completions[i]);
      }
    }
    if (mCompletionOn) {
  ...
  public void onKey(int primaryCode, int[] keyCodes) {
    ...
    switch (primaryCode) {
      ...
      case Keyboard.KEYCODE_CANCEL:
        ...
        break;
      case MorseKeyboardView.KEYCODE_OPTIONS:
        showOptionsMenu();
        break;
      case MorseKeyboardView.KEYCODE_SHIFT_LONGPRESS:
        if (mCapsLock) {
          handleShift();
        } else {
          toggleCapsLock();
  ...
  private void handleCharacter(int primaryCode, int[] keyCodes) {
    ...
    if (mInputView.isShifted()) {
      // TODO: This doesn't work with beta symbol, need to fix it in the next release.
  ...
  private void launchSettings() {
    ...
    intent.setClass(LatinIME.this, MorseIMESettings.class);
  ...
  private void showOptionsMenu() {
    ...
    CharSequence itemSettings = getString(R.string.morse_ime_settings);
